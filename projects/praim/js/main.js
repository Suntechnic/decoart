...
$(".img-6 a.light").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-6 a.dark-mini').removeClass('active');
    $('.img-6 a.dark').removeClass('active');
    $(".img-6 img.dark").hide();
    $(".img-6 img.dark-mini").hide();
...
$(".img-6 a.dark-mini").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-6 a.light').removeClass('active');
    $('.img-6 a.dark').removeClass('active');
    $(".img-6 img.dark-mini").show();
    $(".img-6 img.dark").hide();
    $(".img-6 img.light").hide();
});
...
$(".img-7 a.dark").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-7 a.light').removeClass('active');
    $('.img-7 a.dark-mini').removeClass('active');
    $(".img-7 img.dark").show();
    $(".img-7 img.light").hide();
    $(".img-7 img.dark-mini").hide();
});
$(".img-7 a.dark-mini").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-7 a.light').removeClass('active');
    $('.img-7 a.dark').removeClass('active');
    $(".img-7 img.dark-mini").show();
    $(".img-7 img.dark").hide();
    $(".img-7 img.light").hide();
});
...
$(".img-12 a.light").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-12 a.dark').removeClass('active');
    $('.img-12 a.dark-mini').removeClass('active')
    $('.img-12 a.light-mini').removeClass('active')
    $(".img-12 img.dark").hide();
    $(".img-12 img.light").show();
    $(".img-12 img.dark-mini").hide();
    $(".img-12 img.light-mini").hide();
});
$(".img-12 a.dark").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-12 a.light').removeClass('active');
    $('.img-12 a.dark-mini').removeClass('active')
    $('.img-12 a.light-mini').removeClass('active')
    $(".img-12 img.dark").show();
    $(".img-12 img.light").hide();
    $(".img-12 img.dark-mini").hide();
    $(".img-12 img.light-mini").hide();
});
$(".img-13 a.light").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-13 a.dark').removeClass('active');
    $('.img-13 a.dark-mini').removeClass('active')
    $('.img-13 a.light-mini').removeClass('active')
    $(".img-13 img.dark").hide();
    $(".img-13 img.light").show();
    $(".img-13 img.dark-mini").hide();
    $(".img-13 img.light-mini").hide();
});
$(".img-13 a.dark").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-13 a.light').removeClass('active');
    $('.img-13 a.dark-mini').removeClass('active')
    $('.img-13 a.light-mini').removeClass('active')
    $(".img-13 img.dark").show();
    $(".img-13 img.light").hide();
    $(".img-13 img.dark-mini").hide();
    $(".img-13 img.light-mini").hide();
});
$(".img-13 a.dark-mini").click(function(e) {
    e.preventDefault();
    $(this).addClass('active');
    $('.img-13 a.dark').removeClass('active');
    $('.img-13 a.light').removeClass('active')
