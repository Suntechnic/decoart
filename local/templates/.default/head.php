...
<title><?$APPLICATION->ShowTitle()?></title><meta http-equiv="X-UA-Compatible" content="IE=Edge">
...
$lstScripts = [
        ...
        '/local/assets/wa/jquery-3.6.0.min.js',
        P_JS.'/vendor.js',
        '/local/assets/wa/slick.min.js',
        '//api-maps.yandex.ru/2.1/?apikey=bd07df23-b78d-4752-88e1-a48e3933410b&lang=ru_RU'
    ];
if (APPLICATION_ENV == 'dev') {
    $lstScripts[] = '/local/assets/src/js'.'/80.plagins.js';
    $lstScripts[] = '/local/assets/src/js'.'/99.main.js';
    $lstScripts[] = '/local/assets/src/js'.'/map.js';
} else {
...
<?$APPLICATION->IncludeComponent(
        ...
        '',
        Array(
                'CONFIG' => ['mobileMaxWidth' => 760,'assets'=>['images'=>P_IMAGES]],
                'SCRIPTS' => $lstScripts,
                //''
                'EXTENSIONS' => [
                        'main',
                        ...
                        //'x.vue.ui',
                        'app.vue.components.form',
                        'app.vue.components.form2',
                        'app.vue.components.formjob',
                    ]
            )
    );?>
...
$APPLICATION->SetPageProperty('canonical', $_SERVER["SCRIPT_URL"]);
...
if (FIRST_LOAD) {
    ...
    <link
        ...
        >
    <link href="<?=P_CSS?>/roundslider.min.css" type="text/css" rel="stylesheet">
    <?
} else {
